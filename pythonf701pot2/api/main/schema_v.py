...
@main_bp.route("/pythonf701pot2/cal/<tableName>/<columnName>", methods=['GET'])
def pythonf701pot2_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/pythonf701pot2/file/download", methods=['GET'])
def pythonf701pot2_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythonf701pot2/file/upload", methods=['POST'])
def pythonf701pot2_file_upload():
    '''
    '''
...
@main_bp.route("/pythonf701pot2/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def pythonf701pot2_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythonf701pot2/follow/<tableName>/<columnName>", methods=['GET'])
def pythonf701pot2_follow(tableName, columnName):
    '''
...
@main_bp.route("/pythonf701pot2/location", methods=['GET'])
def pythonf701pot2_location():
    '''
...
@main_bp.route("/pythonf701pot2/matchFace", methods=['GET'])
def pythonf701pot2_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythonf701pot2/option/<tableName>/<columnName>", methods=['GET'])
def pythonf701pot2_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythonf701pot2/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def pythonf701pot2_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/pythonf701pot2/sh/<tableName>", methods=['POST'])
def pythonf701pot2_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("pythonf701pot2_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/pythonf701pot2/upload/<fileName>", methods=['GET'])
def pythonf701pot2_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythonf701pot2/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/pythonf701pot2/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
