...
# 注册接口
@main_bp.route("/pythonf701pot2/forum/register", methods=['POST'])
def pythonf701pot2_forum_register():
...
# 登录接口
@main_bp.route("/pythonf701pot2/forum/login", methods=['GET','POST'])
def pythonf701pot2_forum_login():
...
# 登出接口
@main_bp.route("/pythonf701pot2/forum/logout", methods=['POST'])
def pythonf701pot2_forum_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythonf701pot2/forum/resetPass", methods=['POST'])
def pythonf701pot2_forum_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/pythonf701pot2/forum/session", methods=['GET'])
def pythonf701pot2_forum_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/pythonf701pot2/forum/page", methods=['GET'])
def pythonf701pot2_forum_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/pythonf701pot2/forum/autoSort", methods=['GET'])
def pythonf701pot2_forum_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
#查询单条数据
@main_bp.route("/pythonf701pot2/forum/query", methods=['GET'])
def pythonf701pot2_forum_query():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythonf701pot2/forum/list", methods=['GET'])
def pythonf701pot2_forum_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/pythonf701pot2/forum/save", methods=['POST'])
def pythonf701pot2_forum_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/pythonf701pot2/forum/add", methods=['POST'])
def pythonf701pot2_forum_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/pythonf701pot2/forum/thumbsup/<id_>", methods=['GET'])
def pythonf701pot2_forum_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/pythonf701pot2/forum/info/<id_>", methods=['GET'])
def pythonf701pot2_forum_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/pythonf701pot2/forum/detail/<id_>", methods=['GET'])
def pythonf701pot2_forum_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/pythonf701pot2/forum/update", methods=['POST'])
def pythonf701pot2_forum_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/pythonf701pot2/forum/delete", methods=['POST'])
def pythonf701pot2_forum_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/pythonf701pot2/forum/vote/<int:id_>", methods=['POST'])
def pythonf701pot2_forum_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
@main_bp.route("/pythonf701pot2/forum/flist", methods=['GET'])
def pythonf701pot2_forum_flist():
    '''
    查看所有开放的帖列表(无需登录)
    '''
    if request.method == 'GET':
...
@main_bp.route("/pythonf701pot2/forum/list/<id_>", methods=['GET'])
def pythonf701pot2_forum_list_id(id_):
    '''
    查看主贴和所有回帖内容(无需登录)
    '''
    if request.method == 'GET':
...
# 分组统计接口
@main_bp.route("/pythonf701pot2/forum/group/<columnName>", methods=['GET'])
def pythonf701pot2_forum_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/pythonf701pot2/forum/value/<xColumnName>/<yColumnName>", methods=['GET'])
def pythonf701pot2_forum_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/pythonf701pot2/forum/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def pythonf701pot2_forum_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/pythonf701pot2/forum/valueMul/<xColumnName>", methods=['GET'])
def pythonf701pot2_forum_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/pythonf701pot2/forum/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def pythonf701pot2_forum_valueMul_time(xColumnName,timeStatType):
...
# 统计接口
@main_bp.route("/pythonf701pot2/forum/remind/<columnName>/<type>", methods=['GET'])  #
def pythonf701pot2_forum_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/pythonf701pot2/forum/lists", methods=['GET'])
def pythonf701pot2_forum_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
